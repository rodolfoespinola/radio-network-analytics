...
def calcular(df, mapa_abr, ano, mes):
    ...
    _MESO_MUNIS = {
        "Grande Florianópolis": {
            ...
            "biguacu","florianopolis","governador celso ramos","leoberto leal",
            "major gercino","nova trento","palhoca","paulo lopes","rancho queimado",
            "santo amaro da imperatriz","sao bonifacio","sao joao batista",
            "sao jose","sao pedro de alcantara","tijucas",
        },
        "Norte Catarinense": {
            "araquari","barra velha","campo alegre","corupa","garuva","guaramirim",
            "itapoa","jaragua do sul","joinville","mafra","massaranduba",
            "papanduva","rio negrinho","sao bento do sul","sao francisco do sul",
            "schroeder","tres barras",
        },
        "Vale do Itajaí": {
            "agrolândia","agronômica","apiuna","ascurra","atalanta","aurora",
            "benedito novo","blumenau","botuverá","brusque","doutor pedrinho",
            "gaspar","guabiruba","ibirama","ilhota","indaial","itajai","itapema",
            "jose boiteux","laurentino","lontras","luiz alves","mirim doce",
            "navegantes","penha","pomerode","porto belo","presidente getulio",
            "presidente nereu","rio do campo","rio do oeste","rio dos cedros",
            "rio do sul","rodeio","salete","taio","timbó","vidal ramos",
            "vitor meireles","witmarsum",
        },
        "Oeste Catarinense": {
            "aguas de chapeco","aguas frias","alto bela vista","anchieta","arabutã",
            "arvoredo","bandeirante","barra bonita","belmonte","bom jesus",
            "bom jesus do oeste","caibi","campo ere","caxambu do sul","chapeco",
            "concordia","cordilheira alta","coronel freitas","coronel martins",
            "cunha pora","cunhatai","descanso","dionisio cerqueira",
            "entre rios","faxinal dos guedes","flor do sertao","formosa do sul",
            "galvao","guaraciaba","guarujá do sul","guatambu","ibiam","ibicare",
            "ipira","ипоа do oeste","iraceminha","irani","irati","ita",
            "itapiranga","jaborá","jardinopolis","jupia","lajeado grande",
            "maravilha","marema","modelo","mondai","nova erechim","nova itaberaba",
            "novo horizonte","ouro","ouro verde","paial","palmitos","paraiso",
            "passagem maia","pinhalzinho","planalto alegre","ponte serrada",
            "presidente castello branco","quilombo","riqueza","romelandia",
            "saltinho","santiago do sul","sao carlos","sao domingos",
            "sao joao do oeste","sao jose do cedro","sao lourenco do oeste",
            "sao miguel da boa vista","sao miguel do oeste","saudades","seara",
            "serra alta","sul brasil","tigrinhos","tunapolis","uniao do oeste",
            "vargeao","xanxere","xavantina","xaxim","campo belo do sul",
        },
        "Sul Catarinense": {
            "ararangua","balneario arroio do silva","balneario gaivota",
            "balneario rincao","cocal do sul","coxilha rica","criciuma",
            "ermo","forquilhinha","icara","jacinto machado","jaguaruna",
            "lauro muller","maracaja","meleiro","morro da fumaca","morro grande",
            "nova veneza","orleans","passo de torres","pedras grandes",
            "pescaria brava","praia grande","sangao","santa rosa do sul",
            "sao joao do sul","siderópolis","sombro","timbe do sul","tubarao",
            "treviso","treze de maio","turvo","urussanga",
        },
        "Serrana": {
            "abdon batista","anita garibaldi","bocaina do sul","bom jardim da serra",
            "bom retiro","brunopolis","campo belo do sul","capao alto","celso ramos",
            "cerro negro","correia pinto","curitibanos","frei rogerio","ibiam",
            "lages","monte carlo","otacilio costa","painel","palmeira","ponte alta",
            "ponte alta do norte","rio rufino","sao cristovao do sul",
            "sao jose do cerrito","sao joaquim","urupema","urubici","vargem",
            "zortea","campos novos","capinzal","catanduvas","erval velho",
            "herval d oeste","ibiam","ibicare","joaçaba","lacerdopolis","luzerna",
            "ouro","pinheiro preto","piratuba","tangara","treze tilias",
        },
    }
    cob_meso = {}
